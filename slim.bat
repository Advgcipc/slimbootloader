...
::@set PLATFORM_ID_DEBUGUART=AA000007
::@set PLATFORM_ID_DEBUGUART=AA00FE07
@set PLATFORM_ID_DEBUGUART=AA000002
@set PLATFORM_TYPE=adln
...
@set INPUT_BIOS_BINFILE=Platform/%PLATFORM_PACKAGE%/Binaries/BiosBin/image_C2512D.bin
