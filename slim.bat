@set BIOS_NAME=D58000
@set BIOS_DEBUG=1
@set BIOS_FEATURE=S06
@set BIOS_VERSION=0X001
@set BIOS_IMAGE=%BIOS_NAME%%BIOS_DEBUG%%BIOS_FEATURE%%BIOS_VERSION%.bin
::@set PLATFORM_ID_DEBUGUART=AA00000E
@set PLATFORM_ID_DEBUGUART=AA000010
@set PLATFORM_TYPE=idvh
@set PLATFORM_PACKAGE=IdavilleBoardPkg
...
@set INPUT_BIOS_BINFILE=Platform/%PLATFORM_PACKAGE%/Binaries/BiosBin/D5800000060X018.bin
...
::python BuildLoader.py build idvh -p "OsLoader.efi:LLDR:Lz4;UEFIPAYLOAD_DEBUG.fd:UEFI:Lzma"
...
::@set BASE_PY_FILE=Platform/IdavilleBoardPkg/Script/StitchLoader.py
::@set SBL_SOURCE_BINFILE=Outputs/idvh/SlimBootloader.bin
::@set INPUT_BIOS_BINFILE=Platform/IdavilleBoardPkg/Binaries/BiosBin/D5800000060X018.bin
::@set BIOS_IMAGE=D5800S00060X018.bin
...
::python %BASE_PY_FILE% -i %INPUT_BIOS_BINFILE% -s %SBL_SOURCE_BINFILE% -o Build/%BIOS_IMAGE%
python %STITCH_PY_FILE% -i %INPUT_BIOS_BINFILE% -s %SBL_SOURCE_BINFILE% -o Build/%BIOS_IMAGE%  -p %PLATFORM_ID_DEBUGUART%
