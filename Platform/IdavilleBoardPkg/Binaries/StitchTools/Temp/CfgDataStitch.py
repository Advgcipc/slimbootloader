...
dlt_files = [
  (0x01, 'Autogen_CfgData_Int_Tglu_Ddr4.dlt'),
  (0x03, 'Autogen_CfgData_Int_Tglu_DdrLp4.dlt'),
  (0x0F, 'Autogen_CfgData_Int_Tglh_Ddr4.dlt'),
  (0x04, 'Autogen_CfgDataExt_Upx11.dlt'),
  (0x10, 'Autogen_CfgData_Int_Tglu_SOM7583.dlt')
]
