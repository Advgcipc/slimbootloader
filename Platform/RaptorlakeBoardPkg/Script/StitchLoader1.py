...
#//6884V101_1 def create_ifwi_image (ifwi_in, ifwi_out, sbl_in, platform_data):
def create_ifwi_image (ifwi_out, sbl_in, platform_data):
#//6884V101_1     ifwi_data   = bytearray (get_file_data (ifwi_in))
#//6884V101_1     ifwi_parser = IFWI_PARSER ()
#//6884V101_1     ifwi = ifwi_parser.parse_ifwi_binary (ifwi_data)
#//6884V101_1     if not ifwi:
#//6884V101_1         print ("Invalid IFWI input image!")
#//6884V101_1         return -1
#//6884V101_1 
#//6884V101_1     # update bios region
#//6884V101_1     bios = ifwi_parser.locate_component (ifwi, 'IFWI/BIOS')
#//6884V101_1     if not bios:
#//6884V101_1         print ("Cound not find BIOS region!")
#//6884V101_1         return -2
...
#//6884V101_1     padding  = bios.length - len(bios_data)
#//6884V101_1     if padding < 0:
#//6884V101_1         print ("BIOS image is too big to fit into BIOS region!")
#//6884V101_1         return -4
#//6884V101_1 
#//6884V101_1     bios_data = b'\xff' * padding + bios_data
#//6884V101_1     ret = ifwi_parser.replace_component (ifwi_data, bios_data, 'IFWI/BIOS')
#//6884V101_1     if ret != 0:
#//6884V101_1         print ("Failed to replace BIOS region!")
#//6884V101_1         return -5
    ...
    if ifwi_out == '':
        ifwi_out = ifwi_in
    gen_file_from_object (ifwi_out, bios_data)
#//6884V101_1     gen_file_from_object (ifwi_out, ifwi_data)
...
#//6884V101_1     ap.add_argument('-i',
#//6884V101_1                     '--input-ifwi-file',
#//6884V101_1                     dest='ifwi_in',
#//6884V101_1                     type=str,
#//6884V101_1                     required=True,
#//6884V101_1                     help='Specify input template IFWI image file path')
    ...
    if args.ifwi_out == '' and args.sbl_in == '':
       ...
       ret = create_ifwi_image (args.ifwi_out, args.sbl_in, args.plat_data)
#//6884V101_1         ret = create_ifwi_image (args.ifwi_in, args.ifwi_out, args.sbl_in, args.plat_data)
