...
#//ddd        ('./FlashLayout/GbeRegion/Enabled',                                          'Enabled'),
...
#//ddd        ('./FlashSettings/FlashConfiguration/QuadOutReadEnable',                     'Yes'),
#//ddd        ('./FlashSettings/FlashConfiguration/QuadIoReadEnable',                      'Yes'),
        ...
        ('./FlashSettings/RpmcConfiguration/RpmcOverEc',                            'No'),
...
#        ('./Icc/IccPolicies/Profiles/Profile/ClockOutputConfiguration/ClkoutSRC7',   'Enabled'),
        ('./Icc/IccPolicies/Profiles/Profile/ClockOutputConfiguration/ClkoutSRC4',   'Disabled'),
...
#//ddd
        ...
        ('./InternalPchBuses/EspiConfiguration/EspiEcBusfreq',                       '50MHz'),
        ...
        ('./CpuStraps/CpuStraps/PlatformImonDisable',                                'Disabled'),
        ...
        ('./FlexIO/Type-CSubsystemConfiguration/TypecPort1ConTypeSel',               'Type A'),
        ('./FlexIO/Type-CSubsystemConfiguration/TypecPort2ConTypeSel',               'Type A'),
        ('./FlexIO/Type-CSubsystemConfiguration/TypecPort3ConTypeSel',               'Type A'),
        ('./FlexIO/Type-CSubsystemConfiguration/TypecPort4ConTypeSel',               'Type A'),
