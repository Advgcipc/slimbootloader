...
def get_xml_change_list (platform, plt_params_list):
    ...
    xml_change_list.append ([
      ...
      #Region Order
        ...
        ('./PlatformProtection/BootGuardConfiguration/BtGuardKeyManifestId',         '0'),
        ...
        ('./FlexIO/PowerDelivery_PdControllerConfiguration/TypeCPort3RetimerSmbusAddr',  '0x0'),
        ('./FlexIO/PowerDelivery_PdControllerConfiguration/TypeCPort3SmbusAddr',         '0x0'),
        ('./FlexIO/PowerDelivery_PdControllerConfiguration/TypeCPort4RetimerSmbusAddr',  '0x0'),
        ...
        ('./Gpio/GpioVccioVoltageControl/GppC2voltSelect',                               '3.3Volts'),
        ('./Gpio/GpioVccioVoltageControl/GppC5voltSelect',                               '3.3Volts'),
        ('./Gpio/GpioVccioVoltageControl/GppC8voltSelect',                               '3.3Volts'),
        ('./Gpio/GpioVccioVoltageControl/GppC10voltSelect',                              '3.3Volts'),
        ('./Gpio/GpioVccioVoltageControl/GppC12voltSelect',                              '3.3Volts'),
        ('./Gpio/GpioVccioVoltageControl/GppC15voltSelect',                              '3.3Volts'),
        ('./Gpio/GpioVccioVoltageControl/GppC16voltSelect',                              '3.3Volts'),
        ('./Gpio/GpioVccioVoltageControl/GppC17voltSelect',                              '3.3Volts'),
        ('./Gpio/GpioVccioVoltageControl/GppC18voltSelect',                              '3.3Volts'),
        ('./Gpio/GpioVccioVoltageControl/GppC19voltSelect',                              '3.3Volts'),
        ('./Gpio/GpioVccioVoltageControl/GppD0voltSelect',                               '3.3Volts'),
        ...
        ('./Gpio/GpioVccioVoltageControl/GppD4voltSelect',                               '3.3Volts'),
        ('./Gpio/GpioVccioVoltageControl/GppD17voltSelect',                              '3.3Volts'),
        ('./Gpio/GpioVccioVoltageControl/GppD18voltSelect',                              '3.3Volts'),
        ('./Gpio/GpioVccioVoltageControl/GppD19voltSelect',                              '3.3Volts'),
        ('./Gpio/GpioVccioVoltageControl/GppE0voltSelect',                               '3.3Volts'),
        ('./Gpio/GpioVccioVoltageControl/GppE1voltSelect',                               '3.3Volts'),
        ('./Gpio/GpioVccioVoltageControl/GppE2voltSelect',                               '3.3Volts'),
        ('./Gpio/GpioVccioVoltageControl/GppE3voltSelect',                               '3.3Volts'),
        ('./Gpio/GpioVccioVoltageControl/GppE6voltSelect',                               '3.3Volts'),
        ...
        ('./Gpio/GpioVccioVoltageControl/GppE16voltSelect',                              '3.3Volts'),
        ('./Gpio/GpioVccioVoltageControl/GppF1voltSelect',                               '3.3Volts'),
        ('./Gpio/GpioVccioVoltageControl/GppF3voltSelect',                               '3.3Volts'),
        ...
        ('./Gpio/GpioVccioVoltageControl/GppH13voltSelect',                              '3.3Volts'),
        ('./Gpio/GpioVccioVoltageControl/GppH20voltSelect',                              '3.3Volts'),
        ('./Gpio/GpioVccioVoltageControl/GppH21voltSelect',                              '3.3Volts'),
