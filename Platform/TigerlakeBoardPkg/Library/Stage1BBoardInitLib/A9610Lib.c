...
EFI_STATUS
A9610_NXP3460_RESET_INIT ()
{
	UINTN   Status = EFI_SUCCESS;
	UINT8   PayloadData;

	PayloadData = 0x01; // PTN3460_PD# Reset asserted as default

  Status = EcPmcWrite_Protocol(A9610_CMD_WRITE_PANEL, A9610_CTRL_LVDS_RESET_CONTROL, A9610_DEVICE_1, 0x01, &PayloadData);
